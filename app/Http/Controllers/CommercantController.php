...
class CommercantController extends Controller
{
    ...
    public function inscription_commercant (Request $request){

        /* insertion des données de l'utilisateur  */
        $utilisateurDonnee = $request->validate([

                "commercant_name" => ["required", "string", "min:5", "max:255"],
        ...
        $utilisateursCommercant = Commercant::create([
            
            "commercant_name" => $utilisateurDonnee["commercant_name"],
        ...
        if($utilisateursCommercant){
            ...
            return response($utilisateursCommercant,201); /* renvoi les données avec statu code post 201 */
    ...
    public function connexion_commercant (Request $request){
        ...
        /* insertion des données de l'utilisateur pour la connexion  */
            $utilisateurDonnee = $request->validate([
                ...
                /* verifi l'email et me retourne le premier */
                    $utilisateur = Commercant::where("email", $utilisateurDonnee["email"])->first();
